...
- 测试日期：2026-07-17T07:50:48.904Z
- 代码/应用版本：0.1.33 / 3b9019b
- 主模型：deepseek-v4-pro
- Utility 模型：deepseek-v4-flash
- 测试数据库：chatslg-ai-eval-cli-1784274557792（隔离=是）
...
| acceptance-e2e-outfit-colloquial | real | model_missed | outfit状态结果 |
| acceptance-e2e-location-colloquial | real | model_missed | location状态结果 |
| acceptance-e2e-ambiguous-negative | real | model_missed | location状态结果 |
