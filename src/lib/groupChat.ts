...
{"messages":[{"speakerIndex":1,"type":"text","content":"..."},{"speakerIndex":2,"type":"text","content":"..."}]}
...
export function buildGroupJsonConversionPrompt(rawText: string, speakers: Contact[], _stickerNames: string[], logicContext = ''): string {
